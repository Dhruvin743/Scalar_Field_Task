...
function NavbarExpanded({ setNavbar, navbar }) {
	return (
		<>
			<div className='mt-1 flex flex-col bg-orange-500 grow'>
				...
				<div className='my-4 pt-2 pb-1'>
					<button type='button' className='w-full h-full p-2 rounded-2xl bg-slate-100'>
						search
					</button>
				</div>
				<div className='flex w-full flex-col'>
					<div className='flex h-10 p-4 items-center justify-start gap-2'>
						<svg
							aria-hidden='true'
							focusable='false'
							data-prefix='fak'
				...
				<div>
					<button type='button' className='mt-4 w-full p-2 bg-slate-200 rounded-full'>
						Sign up
					</button>
				</div>
			</div>
